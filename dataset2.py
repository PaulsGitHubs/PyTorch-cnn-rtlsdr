...
def read_train_sets(train_path, classes, validation_size, train_batch_size, valid_batch_size):
    ...
    train_dataset = DataSet2(train_images, train_labels, train_img_names, train_cls)
    valid_dataset = DataSet2(validation_images, validation_labels, validation_img_names, validation_cls)
